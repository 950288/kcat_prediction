...
def uniprotID_entry() :
    ...
    with open("Kcat-km_combination_0116.tsv", "r", encoding='utf-8') as file :
...
def nouniprotID_entry_uniprot() :
    ...
    with open("../../Data/database/Kcat-km_combination_0116.tsv", "r", encoding='utf-8') as file :
        combination_lines = file.readlines()[1:]
...
def nouniprotID_entry_brenda() :
    with open("Kcat-km_combination_0116.tsv", "r") as file :
        combination_lines = file.readlines()[1:]
    ...
    # print(len(entries))  # 28104
    entries_unique = set(entries)
    entries_unique = sorted(list(entries_unique))
    # print(len(entries_unique)) # 7258
...
def combine_sequence() :
    ...
    with open("../../Data/database/Kcat_combination_1120.tsv", "r", encoding='utf-8') as file4 :
    ...
    with open('../../Data/database/Kcat_combination_1120_wildtype_mutant.json', 'w') as outfile :
        json.dump(entries, outfile, indent=4)

def check_substrate_seq() :
    with open('../../Data/database/Kcat_combination_1120.json', 'r') as file :
